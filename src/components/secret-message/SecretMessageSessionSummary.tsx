...
export function SecretMessageSessionSummary({
  game,
}: {
  ...
  return (
    <div className="glass-card p-6 space-y-5 text-center">
      <div className="space-y-1">
        ...
        <p className="text-muted text-sm">Secret Message</p>
      </div>
      ...
      <div className="grid grid-cols-2 gap-4 text-sm text-left">
        ...
        {game.session_started_at && (
          <div>
            <p className="text-faint text-[10px] uppercase tracking-wider">Opened</p>
      ...
      <p className="text-faint text-xs leading-relaxed">
        Secret messages are private to the host and are not stored in game history.
      </p>
    </div>
  )
}
