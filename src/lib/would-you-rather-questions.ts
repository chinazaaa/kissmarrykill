...
export const WYR_QUESTIONS: WyrQuestion[] = [
  ...
  {
    optionA: 'Have a lifetime supply of your favorite snack',
    optionB: 'Have a lifetime supply of your favorite drink',
  },
  { optionA: 'Never have to make your bed again', optionB: 'Never have to fold laundry again' },
  {
    optionA: 'Be able to visit any fictional world for a day',
    optionB: 'Bring one fictional character to the real world for a day',
  },
  ...
  {
    optionA: 'Always have the perfect amount of popcorn at the movies',
    optionB: 'Always have the perfect seat at the movies',
  },
  ...
  {
    optionA: 'Live without forgetting why you walked into a room',
    optionB: 'Live without forgetting names at parties',
  },
  ...
  {
    optionA: 'Be able to make anyone feel ready for a big adventure',
    optionB: 'Be able to make anyone feel ready for a quiet night in',
  },
  {
    optionA: 'Always have the best luck with surprise sunny days',
    optionB: 'Always have the best luck with surprise snow days',
  },
  { optionA: 'Be able to make the best team name', optionB: 'Be able to make the best group chat name' },
  {
    optionA: 'Live without sending a text to the wrong person',
    optionB: 'Live without forgetting to reply to a nice text',
  },
  {
    optionA: 'Be able to make anyone feel like the life of the party',
    optionB: 'Be able to make anyone feel like the heart of the friend group',
  },
  {
    optionA: 'Have a magic button that finds the TV remote',
    optionB: 'Have a magic button that picks a restaurant everyone agrees on',
  },
  {
    optionA: 'Be able to make the best opening line for game night',
    optionB: 'Be able to make the best recap after game night',
  },
  {
    optionA: 'Always have the best luck with surprise compliments',
    optionB: 'Always have the best luck with surprise reunions',
  },
  {
    optionA: 'Be able to keep every friend group drama-free',
    optionB: 'Be able to keep every family gathering drama-free',
  },
  {
    optionA: 'Be able to make anyone feel excited to try something new',
    optionB: 'Be able to make anyone feel safe trying something new',
  },
  { optionA: 'Have a home with a big table for board games', optionB: 'Have a home with a big screen for game nights' },
  {
    optionA: 'Be able to make anyone feel proud of a small win',
    optionB: 'Be able to make anyone feel brave about a big risk',
  },
  ...
  {
    optionA: 'Be able to make anyone feel calm before a big event',
    optionB: 'Be able to make anyone feel excited before a big event',
  },
  ...
  {
    optionA: 'Be able to make anyone feel included in five minutes',
    optionB: 'Be able to make anyone laugh in five minutes',
  },
  ...
  {
    optionA: 'Live in a world where packages never get lost',
    optionB: 'Live in a world where food delivery is never late',
  },
  ...
  {
    optionA: 'Be able to make the best intro for a new player',
    optionB: 'Be able to make the best recap after game night',
  },
  { optionA: 'Have a year of free trampoline parks', optionB: 'Have a year of free climbing gyms' },
  {
    optionA: 'Be able to make anyone feel like they nailed it',
    optionB: 'Be able to make anyone feel like they are enough',
  },
]
